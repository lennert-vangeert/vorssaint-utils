...
struct WindowLayoutFeatureStrings {
    ...
    static let nl = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS gebruikt dezelfde randen. Schakel venstertegels uit bij Bureaublad en Dock zodat Vorssaint het kan overnemen.",
        edgeSnapOpenSystemSettings: "Bureaublad en Dock openen",
        edgeSnapWaitingForSystem: "Ingeschakeld in Vorssaint. Het begint te werken zodra de venstertegels van macOS uit staan.",
